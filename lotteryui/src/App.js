...
class App extends Component {
  ...
  buttonClicked() {
    var address = lotteryContract._eth.accounts[0];
    console.log(address);
  }

  getPlayers() {
    console.log(lotteryContract.getPlayers());
